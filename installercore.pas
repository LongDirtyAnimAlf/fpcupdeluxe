...
const
  ...
  UNWANTEDHINTSOPTIONS='-vm3123,3124,4035,4055,4056,4081,4082,4104,4105,5023,5024,5024,5026,5028,5029,5043,5044,5057,5058,5060,5091';
  ...
  STANDARDCOMPILEROPTIONS='-vw-n-h-i-l-d-u-t-p-c-x- ' + UNWANTEDHINTSOPTIONS;
  {$ENDIF}
