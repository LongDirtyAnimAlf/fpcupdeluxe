...
uses {$IFDEF UNIX}
  ...
  m_win64_to_linux64, m_win32_to_linuxmips, m_win32_to_linuxmipsel,
  m_freebsd_to_linux386, m_freebsd64_to_freebsd32, m_freebsd_to_linux64,
  m_linux386_to_mips, m_linux386_to_mipsel,
...
begin
  ...
  writeln('                       <dir>\config\  configuration data/Laz primary config path');
