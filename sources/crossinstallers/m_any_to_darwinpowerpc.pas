...
uses
  installerBase, m_crossinstaller, m_any_to_apple_base;

type

{ Tany_darwinpowerpc }
Tany_darwinpowerpc = class(Tany_apple)
protected
...
function Tany_darwinpowerpc.GetOSName:string;
begin
  result:=macOSNAME;
end;
function Tany_darwinpowerpc.GetLibName:string;
begin
  result:='libc.dylib';
end;
function Tany_darwinpowerpc.GetTDBLibName:string;
begin
  result:='libc.tbd';
end;
