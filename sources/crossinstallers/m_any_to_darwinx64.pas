...
{ Tany_darwinx64 }
Tany_darwinx64 = class(Tany_apple)
protected
...
function Tany_darwinx64.GetOSName:string;
begin
  result:=macOSNAME;
end;
function Tany_darwinx64.GetLibName:string;
begin
  result:='libc.dylib';
end;
function Tany_darwinx64.GetTDBLibName:string;
begin
  result:='libc.tbd';
end;
