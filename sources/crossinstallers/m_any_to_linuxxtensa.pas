...
{ TAny_LinuxXtensa }
TAny_LinuxXtensa = class(TCrossInstaller)
private
...
function TAny_LinuxXtensa.GetLibs(Basepath:string): boolean;
begin
...
{$ifndef FPCONLY}
function TAny_LinuxXtensa.GetLibsLCL(LCL_Platform: string; Basepath: string): boolean;
begin
...
function TAny_LinuxXtensa.GetBinUtils(Basepath:string): boolean;
var
  AsFile: string;
begin
  result:=inherited;
...
constructor TAny_LinuxXtensa.Create;
begin
  inherited Create;
...
destructor TAny_LinuxXtensa.Destroy;
begin
  inherited Destroy;
end;

var
  Any_LinuxXtensa:TAny_LinuxXtensa;

initialization
  Any_LinuxXtensa:=TAny_LinuxXtensa.Create;
  RegisterCrossCompiler(Any_LinuxXtensa.RegisterName,Any_LinuxXtensa);

finalization
  Any_LinuxXtensa.Destroy;
end.
