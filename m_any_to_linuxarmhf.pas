...
{ Tany_linuxarmhf }
Tany_linuxarmhf = class(TCrossInstaller)
private
...
function Tany_linuxarmhf.GetLibs(Basepath:string): boolean;
const
  DirName='arm-linux';
//var
...
{$ifndef FPCONLY}
function Tany_linuxarmhf.GetLibsLCL(LCL_Platform: string; Basepath: string): boolean;
begin
...
function Tany_linuxarmhf.GetBinUtils(Basepath:string): boolean;
const
  DirName='arm-linux';
var
...
begin
  ...
  begin
    FBinsFound:=true;
    //if hardfloat then ShowInfo('Found hardfloat binary utilities. Please make sure you did NOT specified -dFPC_armhf in your FPCOPT !',etWarning);
...
procedure Tany_linuxarmhf.Reset;
begin
  inherited Reset;
...
var
  any_linuxarmhf:Tany_linuxarmhf;

initialization
  any_linuxarmhf:=Tany_linuxarmhf.Create;
  RegisterExtension(any_linuxarmhf.TargetCPU+'-'+any_linuxarmhf.TargetOS,any_linuxarmhf);
finalization
  any_linuxarmhf.Destroy;
end.
