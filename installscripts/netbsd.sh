...
sudo pkgin -y install liberation-ttf
sudo pkgin -y install lato-ttf

sudo pkgin -y install gtkglext
sudo pkgin -y install gtk3+

sudo pkgin -y install SDL2
sudo pkgin -y install SDL_gfx
...
sudo pkgin -y install qt6-qttools
sudo pkgin -y install qt6-qtwebchannel
sudo pkgin -y install qt6-qtwebsockets
