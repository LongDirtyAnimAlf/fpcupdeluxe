...
SRCDIR=/home/Alfred/binutils-2.29                   # the source code dir for binutils
prefix=/home/Alfred/cross/arm-linux-gnueabi         # installation directory
...
export LDFLAGS='-s'
export DEBUG_FLAGS=''
export GCCFLAGS="--with-arch=armv6 --with-float=soft"
