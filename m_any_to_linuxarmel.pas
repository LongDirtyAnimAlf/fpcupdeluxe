...
{ Tany_linuxarmel }
Tany_linuxarmel = class(TCrossInstaller)
private
...
function Tany_linuxarmel.GetLibs(Basepath:string): boolean;
const
  DirName='arm-linux';
//var
...
{$ifndef FPCONLY}
function Tany_linuxarmel.GetLibsLCL(LCL_Platform: string; Basepath: string): boolean;
begin
...
function Tany_linuxarmel.GetBinUtils(Basepath:string): boolean;
const
  DirName='arm-linux';
var
...
procedure Tany_linuxarmel.Reset;
begin
  inherited Reset;
...
var
  any_linuxarmel:Tany_linuxarmel;

initialization
  any_linuxarmel:=Tany_linuxarmel.Create;
  RegisterExtension(any_linuxarmel.TargetCPU+'-'+any_linuxarmel.TargetOS,any_linuxarmel);
finalization
  any_linuxarmel.Destroy;
end.
